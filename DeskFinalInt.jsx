...
Command: npx gltfjsx@6.5.3 C:\Users\cathy\Desktop\Programs\react\updated-portfolio\src\assets\3d\deskFinalInt.glb 
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF('/deskFinalInt.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <PerspectiveCamera name="persp" makeDefault={false} far={10000} fov={37.849} position={[-70.792, 154.651, 185.15]} rotation={[-2.449, 0.173, 3]}>
          <group name="__DEFAULT_LIGHT__" position={[-70.792, 154.651, 185.15]} rotation={[-0.262, 0, 0]} />
        </PerspectiveCamera>
      </group>
    </group>
  )
...
useGLTF.preload('/deskFinalInt.glb')
