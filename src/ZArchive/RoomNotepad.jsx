        ...
        <group name="Scene">
          <group name="table">
            <group name="keycaps">
              ...
              <a.mesh name="keycap1" ref={handleMeshRef} onPointerDown={handlePointerDown} position={keycap1} geometry={nodes.key59.geometry} material={materials.m_keycapYellowBaked} />
              ...
              <a.mesh name="keycap2" ref={handleMeshRef} onPointerDown={handlePointerDown} geometry={nodes.key62.geometry} material={materials.m_keycapBlueBaked} />
            </group>
            <mesh name="table" ref={handleMeshRef} geometry={nodes.cushion.geometry} material={materials.m_cushionBaked} />
            <group name="monitor1">
              <mesh name="screen1" ref={handleMeshRef} geometry={nodes.monitor1Shape.geometry} material={materials.m_blackFlat} />
              <mesh name="screen1" ref={handleMeshRef} geometry={nodes.monitor1Shape_1.geometry} material={materials.m_whiteMonitorBaked} />
            ...
            <group name="monitor2">
              <mesh name="screen2" ref={handleMeshRef} geometry={nodes.monitor2Shape.geometry} material={materials.m_blackFlat} />
              <mesh name="screen2" ref={handleMeshRef} geometry={nodes.monitor2Shape_1.geometry} material={materials.m_whiteMonitorBaked} />
            ...
            <mesh name="resume" ref={handleMeshRef} geometry={nodes.resume.geometry} material={materials.m_whitePaperBaked} />
            ...
            <mesh name="table" ref={handleMeshRef} geometry={nodes.table_1.geometry} material={materials.m_tableHeadsetWhiteBaked} position={[0, 1.114, 0]} />
          ...
          <group name="modelsShelf">
            ...
            <mesh name="modelsShelf" ref={handleMeshRef} geometry={nodes.modelsHitbox.geometry} material={materials.m_hitbox1} position={[-389.412, 207.232, 119.528]} scale={[2.977, 112.544, 141.696]} />
            <mesh name="modelsShelf" ref={handleMeshRef} geometry={nodes._modelsShelf.geometry} material={materials.m_woodShelfBaked} />
            <mesh name="modelsScreen" ref={handleMeshRef} geometry={nodes.modelsScreen.geometry} material={materials.m_digitalFrameBaked} position={[-386.894, 312.47, 26.769]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={[0.108, 0.004, 4.959]} />
            ...
            <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerHitbox.geometry} material={materials.m_hitbox1} position={[-370.295, 293.418, 155.738]} scale={3.793} />
            <group name="flower">
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape.geometry} material={materials.m_plantStemBaked} />
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape_1.geometry} material={materials.m_flowerCenterBaked} />
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape_2.geometry} material={materials.m_flowerLeafsBaked} />
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape_3.geometry} material={materials.m_lilyBaked} />
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape_4.geometry} material={materials.m_plantBroadLeafBaked} />
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape_5.geometry} material={materials.m_plantPotBaked} />
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape_6.geometry} material={materials.m_lily1Baked} />
              <mesh name="flower" ref={handleMeshRef} geometry={nodes.flowerShape_7.geometry} material={materials.m_lilyWater} />
            </group>
            <group name="boat">
              <mesh name="boat" ref={handleMeshRef} geometry={nodes.boatShape.geometry} material={materials.m_lanternHandleBaked} />
              <mesh name="boat" ref={handleMeshRef} geometry={nodes.boatShape_1.geometry} material={materials.m_boatRust} />
              <mesh name="boat" ref={handleMeshRef} geometry={nodes.boatShape_2.geometry} material={materials.m_boatBaked} />
              <mesh name="boat" ref={handleMeshRef} geometry={nodes.boatShape_3.geometry} material={materials.m_lanternGlass} />
              <mesh name="boat" ref={handleMeshRef} geometry={nodes.boatShape_4.geometry} material={materials.m_lanternBaked} />
              <mesh name="boat" ref={handleMeshRef} geometry={nodes.boatShape_5.geometry} material={materials.m_oarBaked} />
            </group>
            <group name="egg">
            ...
            <mesh name="egg" ref={handleMeshRef} geometry={nodes.eggHitbox.geometry} material={materials.m_hitbox1} position={[-364.516, 255.032, 25.599]} scale={0.846} />
            <group name="animPlayer">
              <mesh name="animPlayer" ref={handleMeshRef} geometry={nodes.animPlayerShape.geometry} material={materials.m_animPlayerBaked} />
              <mesh name="animPlayer" ref={handleMeshRef} geometry={nodes.animPlayerShape_1.geometry} material={materials.m_keycapYellowBaked} />
            </group>
          </group>
          <group name="artWall">
            <group name="miniPlayer">
              <group name="miniPlayer_1">
                <mesh name="miniPlayer" ref={handleMeshRef} geometry={nodes.miniPlayerShape.geometry} material={materials.m_miniPlayerFaceBaked} />
                <mesh name="miniPlayer" ref={handleMeshRef} geometry={nodes.miniPlayerShape_1.geometry} material={materials.m_miniPlayerWoodBaked} />
                <mesh name="miniPlayer" ref={handleMeshRef} geometry={nodes.miniPlayerShape_2.geometry} material={materials.m_blackRubberBaked} />
                <mesh name="miniPlayer" ref={handleMeshRef} geometry={nodes.miniPlayerShape_3.geometry} material={materials.m_blackBaked} />
              </group>
              <a.mesh name="arrowLeft" ref={handleMeshRef} position={positionLeft} onPointerDown={handlePointerDown} geometry={nodes.arrowLeft.geometry} material={materials.m_controlButtonsBaked} />
              <a.mesh name="arrowRight" ref={handleMeshRef} position={positionRight} onPointerDown={handlePointerDown} geometry={nodes.arrowRight.geometry} material={materials.m_controlButtonsBaked} />
            ...
            <mesh name="artWall" ref={handleMeshRef} geometry={nodes._shelf1.geometry} material={materials.m_woodShelfBaked} position={[64.396, 212.258, 359.733]} rotation={[Math.PI / 2, 0, 0]} scale={[0.182, 0.039, 0.602]} />
            <group name="inkwell">
            ...
            <group name="tidalBasin">
              <mesh name="sketchbook" ref={handleMeshRef} geometry={nodes.tidalBasinShape.geometry} material={materials.m_artTidalBasin} />
              <mesh name="sketchbook" ref={handleMeshRef} geometry={nodes.tidalBasinShape_1.geometry} material={materials.m_whitePaperBaked} />
              <mesh name="sketchbook" ref={handleMeshRef} geometry={nodes.tidalBasinShape_2.geometry} material={materials.m_blackBaked} />
            </group>
            <group name="door">
            ...
            <group name="corkboard">
              <mesh name="corkboard" ref={handleMeshRef} geometry={nodes.corkboardShape.geometry} material={materials.m_whiteFrameBaked} />
              <mesh name="corkboard" ref={handleMeshRef} geometry={nodes.corkboardShape_1.geometry} material={materials.m_corkSurfaceBaked} />
              <mesh name="corkboard" ref={handleMeshRef} geometry={nodes.corkboardShape_2.geometry} material={materials.m_keycapYellowBaked} />
            </group>
            <mesh name="businessCard" ref={handleMeshRef} geometry={nodes.businessCard.geometry} material={materials.m_artBusinessCard} position={[133.634, 244.941, 374.941]} rotation={[Math.PI / 2, -0.031, -Math.PI]} scale={[25.739, 84.174, 14.145]} />
            <mesh name="drawingFish" ref={handleMeshRef} geometry={nodes.fish.geometry} material={materials.m_artDrawingFish} position={[184.242, 133.823, 373.165]} rotation={[Math.PI / 2, 0, Math.PI]} scale={[50.416, 54.923, 71.539]} />
            <mesh name="drawingHand" ref={handleMeshRef} geometry={nodes.hand.geometry} material={materials.m_artDrawingHand} position={[258.045, 93.144, 373.493]} rotation={[Math.PI / 2, 0.021, Math.PI]} scale={[81.023, 81.023, 115.7]} />
            <mesh name="drawingDavid" ref={handleMeshRef} geometry={nodes.david.geometry} material={materials.m_artDrawingDavid} position={[148.119, 211.543, 375.008]} rotation={[Math.PI / 2, -0.013, -Math.PI]} scale={[50.416, 54.923, 71.539]} />
          </group>
          <group name="vrShelf">
            <group name="anivision" position={[37.445, 0, 43.159]} rotation={[0, -0.126, 0]}>
              ...
              <group name="anivisionModel" position={[-42.589, 0, -38.092]} rotation={[0, 0.126, 0]}>
                <mesh name="anivision" ref={handleMeshRef} geometry={nodes.anivisionModelShape.geometry} material={materials.m_mushroomBaked} />
                <mesh name="anivision" ref={handleMeshRef} geometry={nodes.anivisionModelShape_1.geometry} material={materials.m_dioramaBase} />
              </group>
            </group>
            <mesh name="vrShelf" ref={handleMeshRef} geometry={nodes.vrShelfHitbox.geometry} material={materials.m_hitbox1} position={[-383.315, 84.175, 325.738]} scale={[7.79, 321.456, 100.227]} />
            <mesh name="vrShelf" ref={handleMeshRef} geometry={nodes.vrShelf_1.geometry} material={materials.m_woodShelfBaked} />
            ...
            <mesh name="descSpacesButton" ref={handleMeshRef} geometry={nodes.descSpacesButton.geometry} material={materials.m_descSpacesButtonBaked} position={[-273.87, 239.114, 265.207]} rotation={[0.673, -0.664, 0.451]} scale={1.566} />
{showHtmlUI && (
  <Html
    scale={[2, -2, -2]}
      ...
      <>
        ...
        >
          <Spaces3D onScreenClick={handleScreenClick} currState={currState} />
              ...
              {/* <mesh name="headsetShape_3" position={[-680, -108, 240]} rotation={[-0.05, 2.38, 0]} geometry={nodes.headsetShape_3.geometry} material={materials.m_tableHeadsetWhiteBaked} /> */}
            <mesh name="spaces" ref={handleMeshRef} geometry={nodes.escher.geometry} material={materials.m_escherBaked} position={[-295.653, 322.289, 291.297]} rotation={[0, 1.57, Math.PI]} scale={[1.775, 1.775, -1.775]} />
          ...
          <group name="architecture">
            <mesh name="home" ref={handleMeshRef} geometry={nodes.wallLeft.geometry} material={materials.m_wallBaked} position={[14, 0, -801.8]} rotation={[0, -Math.PI / 2, 0]} scale={[1, 1, -1]} />
            <group name="architecture_1">
              <mesh name="home" ref={handleMeshRef} geometry={nodes.architectureShape.geometry} material={materials.m_rugBaked} />
              <mesh name="home" ref={handleMeshRef} geometry={nodes.architectureShape_1.geometry} material={materials.m_floorBaked} />
              <mesh name="home" ref={handleMeshRef} geometry={nodes.architectureShape_2.geometry} material={materials.m_wallBaked} />
              <mesh name="home" ref={handleMeshRef} geometry={nodes.architectureShape_3.geometry} material={materials.m_woodShelfBaked} />
            </group>
          </group>
        </group>
        {/* <group name="Scene">
