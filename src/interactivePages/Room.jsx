    ...
    <a.group ref={roomRef}{...props}>
      <group rotation={[0, -0.02, 0]} scale={0.1}>
        ...
        <group name="modelsShelf">
          ...
          <mesh ref={handleMeshRef} name="modelsScreen" geometry={nodes.modelsScreen.geometry} material={materials.m_digitalFrameBaked} position={[-386.894, 312.47, 27]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={[0.105, 0.004, 4.959]} />
