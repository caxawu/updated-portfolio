...
const Room = ({isRotating, setIsRotating, setCurrentStage, updateCameraPosition, updateCameraLookAt, defaultCamera, setFocusState, ...props}) => {
  ...
  const handlePointerMove = (e) => {
    ...
    if (isRotating) {
        ...
        ? e.touches[0].clientX 
        : e.clientX;
        // if (roomRef.current.rotation.y > 8.8 && roomRef.current.rotation.y < 10.2) {
        ...
        // }
        // if (roomRef.current.rotation.y < 8.8) {
        //   roomRef.current.rotation.y = 8.801;
        // }
        // if (roomRef.current.rotation.y > 10.2) {
        //   roomRef.current.rotation.y = 10.199;
        // }
    }
  }
...
const Modal = () => {
  ...
  useFrame (() => {
    if (!isRotating && roomRef.current.rotation.y > 8.8 && roomRef.current.rotation.y < 10.2) {
