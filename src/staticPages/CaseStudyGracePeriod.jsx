    ...
    return (
        <div className="content">
            ...
            <div className='summary'>
                <div>
                    ...
                    <div className="case-study-img">
                        <img src={comparisonChart} alt="functionality comparison chart" loading="eager" />
                    </div>
                    <div className="summary-section">
            ...
            <div className="detail-section">
                <div id="grace-deco" className="section-title text-secondary">research</div>
                <div className="text-block">
                ...
                <div id="grace-text" className="text-callout">
            ...
            <div className="detail-section">
                <div id="grace-deco" className="section-title text-secondary">design</div>
                <div className="text-block">
